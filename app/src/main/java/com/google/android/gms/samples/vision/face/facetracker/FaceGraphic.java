...
class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    private float LEFT_RYE_OPEN_PROVABILITY = 0.10f;
    ...
    public void draw(Canvas canvas) {
        ...
        && (face.getIsRightEyeOpenProbability()< 0.38 && RIGHT_RYE_OPEN_PROVABILITY > 0.38)){
            ...
            EYE_BLINK_COUNTER++;
            EYE_BLINK_FLAG = true;
            canvas.drawText("Blink:"+ EYE_BLINK_COUNTER , x + ID_X_OFFSET, y + ID_Y_OFFSET, mIdPaint);
        }else{
            LEFT_RYE_OPEN_PROVABILITY = face.getIsLeftEyeOpenProbability();
            RIGHT_RYE_OPEN_PROVABILITY = face.getIsRightEyeOpenProbability();
        }
